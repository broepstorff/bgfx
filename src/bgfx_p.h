...
#ifndef BGFX_CONFIG_SHOW_TRACE
#	define BGFX_CONFIG_SHOW_TRACE 1
#endif // BGFX_CONFIG_SHOW_TRACE

#ifndef BGFX_CONFIG_SHOW_WARN
#	define BGFX_CONFIG_SHOW_WARN 1
#endif // BGFX_CONFIG_SHOW_WARN

#if BGFX_CONFIG_DEBUG || BX_COMPILER_CLANG_ANALYZER
#	if BGFX_CONFIG_SHOW_TRACE
#		define BX_TRACE _BX_TRACE
#	endif
#	if BGFX_CONFIG_SHOW_WARN
